...
- [ ] Add flashlight vizualizer (same UI as Haptics, add it at the bottom of the haptics screen for now)
- [ ] Make categories for this Todo list. (rlly need a list for something only Aleks should do and not anyone else, cuz he knows what he meant and has the exact vision of what he wants... Please it's not against you Oliver. Also need to make an Oliver reserved list)
